...
<script type="text/javascript" src="<?php echo base_url(); ?>js/jquery-1.12.4.min.js"></script>
        ...
        <!-- Mobile Menu -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/mmenu.min.js"></script>
        
        <!-- Harvey - State manager for media queries -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/harvey.min.js"></script>
        
        <!-- Waypoints - Load Elements on View -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/waypoints.min.js"></script>

        <!-- Facts Counter -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/facts.counter.min.js"></script>

        <!-- MixItUp - Category Filter -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/mixitup.min.js"></script>

        <!-- Owl Carousel -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/owl.carousel.min.js"></script>
        
        <!-- Accordion -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/accordion.min.js"></script>
        
        <!-- Responsive Tabs -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/responsive.tabs.min.js"></script>
        
        <!-- Responsive Table -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/responsive.table.min.js"></script>
        
        <!-- Masonry -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/masonry.min.js"></script>
        
        <!-- Carousel Swipe -->
        <script type="text/javascript" src="<?php echo base_url(); ?>js/carousel.swipe.min.js"></script>
...
<!-- Mirrored from libraria.demo.presstigers.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Jun 2018 05:45:57 GMT -->
</html>