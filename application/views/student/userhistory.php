                                                            ...
                                                            <table class="table table-bordered shop_table cart">
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="product-price">Fine Amount </th>                                                                
                                                                    ...
                                                                    <tr class="cart_item">
                                                                        ...
                                                                        <td data-title="Product" class="product-name">
                                                                            <span class="product-thumbnail">
                                                                                <a href="#"><img style="height: 100px;width: 100px;" alt="Book" src="<?php echo base_url();?>uploads/<?php echo $tbl['book_photo']; ?>" /></a>
                                                                            </span>
                                                                            <span class="product-detail">
                                                                                <a href="#"><strong><?php echo $tbl['book_title']; ?></strong></a>
                                                                                <span><strong>Author:</strong><?php echo $tbl['author_name']; ?></span>
                                                                                <span><strong>ISBN:</strong><?php echo $tbl['isbn_no']; ?></span>
                                                                                
                                                                            </span>
                                                                        </td>
                                                                        <td data-title="action" class="product-action">
                                                                            <div class="dropdown">
                                                                                <a  class="dropdown-toggle"><?php echo $tbl['book_availability']; ?></a>
                                                                        ...
                                                                        <td data-title="Price" class="product-price">
                                                                            <p>Rs<h3><b><?php echo $tbl['fine_amt']; ?></b><h3></p>
                                                                        </td>
