        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Fine Ammount Form</h3>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Fine Ammount </h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="<?php echo base_url('Admin/fine_ammount_user'); ?>">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Fine Ammount</label>
                                                    <input type="hidden"  name="id" class="form-control" value="<?php echo $id = $this->uri->segment(3); ?>" >
                                                    <input type="text" name="txt_fine_amt" value="<?php echo $fine_amt_user; ?>" class="form-control">
