        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Add Author Form</h3>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Author Add Form </h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="<?php echo base_url('Admin/add_author'); ?>">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="firstName" name="txt_author_add" class="form-control" placeholder="Author Name">
