        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Notification Add Form</h3>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">New Notification Form </h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="notificationtype" name="txt_notification_type" class="form-control" placeholder="Notification Type">
                                            ...
                                            <!-- <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="booktitle" name="txt_book_title" class="form-control" placeholder="Book Title">
                                             ...
                                             <!-- <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="bookpublisher" name="txt_book_publisher" class="form-control" placeholder="Book Publisher">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" name="book_photo_upload" id="exampleInputFile" aria-describedby="fileHelp">
                                                </div>
                                            </div> -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id=" Message Title" name="txt_msg_title" class="form-control" placeholder="Message Title">
                                                    </div> 
                                            </div>
                                             ...
                                             <!-- <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="1900" max="2020" step="1" value="2016"  id="Requested Book Edition Year" name="txt_book_editionyr" class="form-control" placeholder="Book Edition Year">
                                                    </div>
                                            </div> -->
                                            ...
                                            <!-- <div class="form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="date" name="txt_book_date" value="2011-08-19" id="example-date-input">
                                                 </div>
                                            </div> -->

                                            <div class="card">
                                                 <div class="card-body">
                                                        <h4 class="card-title">Enter Message Subject</h4>
                                            
                                            
                                                    <div class="form-group">
                                                        <textarea class="textarea_editor form-control" rows="15" placeholder="Enter text ..." name="txtarea_message_subject" ></textarea>
                                                    </div>
