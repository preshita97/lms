                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                        <?php foreach ($user_item as $tbl): ?>

                                        <tr>
                                            <td><?php echo $tbl['u_email_id']; ?></td>
                                            <td><?php echo $tbl['u_name']; ?></td>
                                            <td><div class="u-img"><img style="height: 100px;width: 100px;" src="<?php echo base_url(); ?>uploads/<?php echo $tbl['u_img']; ?>" alt="user image"></div></td>
                                            <td><?php echo $tbl['u_mno']; ?></td>
