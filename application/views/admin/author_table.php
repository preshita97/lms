        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Author Table</h3>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td><?php echo $tbl['author_name']; ?></td>
                                            <td>
                                            <a href="<?php echo base_url('Admin/author_delete/'.$tbl['author_id']); ?>"><button alt="default"  type="button" onClick="return del()"  class="btn btn-danger btn-circle"><i class="mdi mdi-delete-forever">  </i> </button></a>
                                            <a href="<?php echo base_url('Admin/author_update/'.$tbl['author_id']); ?>"><button alt="default"  type="button" onClick="return edit()"  class="btn btn-success btn-circle"><i class="mdi mdi-grease-pencil">  </i> </button></a>
                                            </td>
                                         </tr>
                                        <?php endforeach; ?>
                                        </tbody>
