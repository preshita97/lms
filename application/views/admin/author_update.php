        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Author Name Edit Form</h3>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Author Name Edit Form </h4>
                            </div>
                            <div class="card-body">
                                <form method="POST">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="firstName" name="txt_author_edit" class="form-control" value="<?php echo $author_item['author_name']; ?>">
