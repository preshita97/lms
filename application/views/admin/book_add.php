        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-themecolor">Book Add Form</h3>
                </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="isbnno" name="txt_isbnno" class="form-control" placeholder="ISBN No">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id=" Book Edition" name="txt_book_edition" class="form-control" placeholder="Book Edition">
                                                    <!-- <small class="form-control-feedback"> This field has error. </small>  -->
                                                    </div> 
                                            </div>
