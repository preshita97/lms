                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                <h6><?php echo $user_item['u_email_id'] ;?></h6> <small class="text-muted p-t-30 db">Phone</small>
                                <h6><?php echo $user_item['u_mno'] ;?></h6> <small class="text-muted p-t-30 db">Type</small>
                                <h6><?php echo $user_item['u_type'] ;?></h6>
                                <!-- <div class="map-box">
                                    ...
                                    <div class="card-body">
                                        <form enctype="multipart/form-data" class="form-horizontal form-material" method="POST" action="<?php echo base_url('Admin/edit_profile'); ?>">
                                            ...
                                            <!-- <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="email" placeholder="johnathan@admin.com" value="<?php echo $user_item['u_email_id'] ;?>" class="form-control form-control-line" name="example-email" id="example-email">
                                                </div>
                                            </div> -->
                                            <div class="form-group">
